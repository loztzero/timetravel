				...
				<form role="form" class="form-horizontal" method="post" action="{{ url('tour-profile/save') }}" enctype="multipart/form-data" data-toggle="validator">
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<input id="first_name" name="first_name" type="text" class="form-control input-lg br-0" placeholder="John" value="{{ $tourProfile['first_name'] }}" required>
						</div>
						<div class="col-sm-6">
							<label class="control-label c-persimmon">Last name</label>
							<input id="last_name" name="last_name" type="text" class="form-control input-lg br-0" placeholder="Doe" value="{{ $tourProfile['last_name'] }}" required>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label c-persimmon">Tour Name</label>
							<input id="tour_name" name="tour_name" type="text" class="form-control input-lg br-0" placeholder="Everyday Tour" value="{{ $tourProfile['tour_name'] }}" required>
						</div>
						<div class="col-sm-6">
							<label class="control-label c-persimmon">Phone number</label>
							<input id="phone_number" name="phone_number" type="tel" class="form-control input-lg br-0" placeholder="e.g. +628711000" value="{{ $tourProfile['phone_number'] }}" required>
						</div>
					</div>
					<div class="space-1"></div>
					<div class="form-group">
						<div class="col-sm-12">
							...
							<input id="address1" name="address1" type="text" class="form-control input-lg br-0" placeholder="Address line 1" value="{{ $tourProfile['address1'] }}" required><br>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<input id="zip_code" name="zip_code" type="text" class="form-control input-lg br-0" placeholder="Zip Code/Postal Code" value="{{ $tourProfile['zip_code'] }}" required><br>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-6">
