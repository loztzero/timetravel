...
CREATE TABLE `MST003` (
    ...
    CONSTRAINT `TUC_MST003_1` UNIQUE (`city_code`)
)
ENGINE=InnoDB;;
...
CREATE TABLE `TR0050` (
    ...
    CONSTRAINT `TUC_TR0050_1` UNIQUE (`mst001_id`, `ask_date`, `mst003_id`, `mst002_id`, `tr0010_id`)
)
ENGINE=InnoDB;;
...
ALTER TABLE `TR0050` ADD CONSTRAINT `MST001_TR0050` 
    FOREIGN KEY (`id`) REFERENCES `MST001` (`id`);

ALTER TABLE `TR0050` ADD CONSTRAINT `TR0010_TR0050` 
    FOREIGN KEY (`tr0010_id`) REFERENCES `TR0010` (`id`);
